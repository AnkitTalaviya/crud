...
export function InventoryCard({ item, onView, onEdit, onDelete }) {
  return (
    <div className="surface-panel p-5">
      ...
      <div className="mt-5 grid grid-cols-2 gap-3">
        ...
        <div className="rounded-3xl bg-slate-50 p-4 dark:bg-slate-900/60">
          <p className="text-xs uppercase tracking-[0.18em] text-slate-400">Value</p>
          <p className="mt-2 text-2xl font-semibold">{formatCurrency(getInventoryValue(item))}</p>
        </div>
      </div>
